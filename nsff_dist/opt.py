...
def get_opts():
    ...
    parser.add_argument('--hard_sampling', default=True, action="store_true",
    ...
    parser.add_argument('--ckpt_path', type=str, default='ckpts/jump_distort_0/epoch=89.ckpt',
                        help='pretrained checkpoint to load (including optimizers, etc)')
    ...
    parser.add_argument('--exp_name', type=str, default='jump_distort_0',
