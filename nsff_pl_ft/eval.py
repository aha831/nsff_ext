...
def get_opts():
    ...
    parser.add_argument('--root_dir', type=str, default='jumping',
                        help='root directory of dataset')
    parser.add_argument('--dataset_name', type=str, default='monocular',
                        choices=['monocular'],
                        help='which dataset to validate')
    parser.add_argument('--scene_name', type=str, default='test_jump_0',
                        help='scene name, used as output folder name')
    parser.add_argument('--split', type=str, default='test_spiral',
    ...
    parser.add_argument('--start_end', nargs="+", type=int, default=[0, 24],
                        help='start frame and end frame')

    parser.add_argument('--use_viewdir', default=True, action="store_true",
    ...
    parser.add_argument('--output_transient', default=True, action="store_true",
                        help='whether to output the full result (static+transient)')

    # parser.add_argument('--ckpt_path', type=str, required=True,
    #                     help='pretrained checkpoint path to load')
    parser.add_argument('--ckpt_path', type=str, default='/home/dl/yulinquan3/nsff_pl/ckpts/jump0/epoch=99.ckpt',
                        help='pretrained checkpoint path to load')
    # parser.add_argument('--ckpt_path', type=str, default='/home/dl/yulinquan3/nsff_pl/ckpts/umbrella_0/epoch=15.ckpt',
    #                     help='pretrained checkpoint path to load')
